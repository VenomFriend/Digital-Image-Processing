...
def decodeImageBinary(imgName, decode=True):
	...
	save_path = os.path.join(savePath, imgName + "_without4Bits.tif")
	for yy in range(height):
		for xx in range(width):
	...
	a6[a6 > 0] = 255
	a7[a7 > 0] = 255
	Image.fromarray(a7).save(savePath / "a7.tif")
	Image.fromarray(a6).save(savePath / "a6.tif")
	Image.fromarray(a5).save(savePath / "a5.tif")
	Image.fromarray(a4).save(savePath / "a4.tif")
	Image.fromarray(a3).save(savePath / "a3.tif")
	Image.fromarray(a2).save(savePath / "a2.tif")
	Image.fromarray(a1).save(savePath / "a1.tif")
	Image.fromarray(a0).save(savePath / "a0.tif")
...
def decodeImageGray(imgName, decode=True):
	...
	save_path = os.path.join(savePath, imgName + "_without4Bits.png")
	os.makedirs(os.path.dirname(save_path), exist_ok=True)
	Image.fromarray(newImageArray).save(save_path)
	...
	g6[g6 > 0] = 255
	g7[g7 > 0] = 255
	Image.fromarray(g7).save(savePath / "g7.tif")
	Image.fromarray(g6).save(savePath / "g6.tif")
	Image.fromarray(g5).save(savePath / "g5.tif")
	Image.fromarray(g4).save(savePath / "g4.tif")
	Image.fromarray(g3).save(savePath / "g3.tif")
	Image.fromarray(g2).save(savePath / "g2.tif")
	Image.fromarray(g1).save(savePath / "g1.tif")
	Image.fromarray(g0).save(savePath / "g0.tif")
...
decodeImageBinary("Image_(2)")
decodeImageGray("Image_(2)")
end = time.time()
